...
func (s *startCmd) Run() error {
	...
	// Overwrite JSON here
	// TODO: Restructure client config
	clientConfig.Flags.FlagAddr = &s.Address
	clientConfig.Flags.FlagRequestor = &s.Requestor
	clientConfig.Flags.FlagLogLevel = &s.LogLevel
